...
class QuestionService:
    ...
    def add_mcq_question(self, exam_id: int, question_text: str, marks: int, options: list, correct_option_index: int):
    ...
    def update_mcq_question(self, question_id: int, question_text: str, marks: int, options: list, correct_option_index: int):
    ...
    def add_essay_question(self, exam_id: int, question_text: str, marks: int, rubric: str = None, 
                          word_limit: int = None, reference_answer: str = None):
    ...
    def update_essay_question(self, question_id: int, question_text: str, marks: int, 
                             rubric: str = None, word_limit: int = None, reference_answer: str = None):
